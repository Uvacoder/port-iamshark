---
title: 'Part 1 - Neuralsdh cksdc Networks and Deep Learning'
...
<Image
  alt={`Image`}
  src={`/static/images/Part1-Neural-Networks-and-Deep-Learning/banner.jpeg`}
  width={720}
  height={370}
  priority
/>  
...
<Image
  alt={`Image`}
  src={`/static/images/Part1-Neural-Networks-and-Deep-Learning/nn_1.png`}
  width={229}
  height={91}
  priority
/> 
...
<Image
  alt={`Image`}
  src={`/static/images/Part1-Neural-Networks-and-Deep-Learning/nn_2.png`}
  width={729}
  height={191}
  priority
/> 
...
<Image
  alt={`Image`}
  src={`/static/images/Part1-Neural-Networks-and-Deep-Learning/nn_3.png`}
  width={729}
  height={191}
  priority
/> 
